...
<body class="bg-black text-white">
    ...
    <nav class="fixed w-full top-0 z-50 bg-black/95 border-b border-purple-500/30 backdrop-blur-xl">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-6">
                ...
                <button id="cerrar-sesion" class="px-6 py-2 border-2 border-purple-500 text-purple-400 font-bold text-sm rounded-lg hover:bg-purple-500/10 transition-all">CERRAR SESIÓN</button>
            </div>
        </div>
    </nav>
        ...
        <main class="ml-64 flex-1 p-8">
            ...
            <div id="pagina-inicio" class="pagina-contenido">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div class="bg-gradient-to-br from-cyan-500/20 to-cyan-500/5 border border-cyan-500/30 rounded-xl p-6">
                        ...
                        <p class="text-xs text-gray-400 mt-2">↑ 12% vs mes anterior</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-purple-500/20 to-purple-500/5 border border-purple-500/30 rounded-xl p-6">
                        <p class="text-xs text-purple-300 font-bold mb-2">PROMEDIO/SESIÓN</p>
                    ...
                    <div class="bg-gradient-to-br from-yellow-500/20 to-yellow-500/5 border border-yellow-500/30 rounded-xl p-6">
                        ...
                        <p class="text-xs text-gray-400 mt-2">Inversión total: $545</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gradient-to-r from-yellow-500/30 to-yellow-500/10 border border-yellow-500/50 rounded-lg">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Tu posición</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center justify-between p-3 bg-gradient-to-r from-cyan-500/20 to-transparent rounded-lg border border-cyan-500/30">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-cyan-300">Tú - Juan Pérez</span>
                                    </div>
                    ...
                    <div class="bg-white/5 border border-white/10 rounded-xl p-6">
                        <h2 class="text-xl font-bold mb-6">PRÓXIMOS EVENTOS</h2>
                        <div class="space-y-4">
                            <div class="bg-gradient-to-r from-cyan-500/20 to-cyan-500/5 border border-cyan-500/30 rounded-lg p-4">
                                ...
                                <p class="text-xs text-gray-400 mt-1">$50 buy-in • 50 premios</p>
                            ...
                            <div class="bg-gradient-to-r from-purple-500/20 to-purple-500/5 border border-purple-500/30 rounded-lg p-4">
                                ...
                                <p class="text-xs text-gray-400 mt-1">$100 buy-in • 25 premios</p>
                            ...
                            <div class="bg-white/5 border border-white/10 rounded-lg p-4">
                                ...
                                <p class="text-xs text-gray-400 mt-1">$500 + invitación</p>
                                <p class="text-xs text-yellow-400 mt-3">✓ Ya inscrito</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-xl p-6 mb-8">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-xl font-bold">ÚLTIMAS SESIONES</h2>
                        <button onclick="mostrarPagina('sesiones')" class="px-4 py-2 bg-cyan-500/20 border border-cyan-500/50 text-cyan-400 font-bold text-sm rounded-lg hover:bg-cyan-500/30 transition-all">+ Registrar sesión</button>
                    </div>
                ...
                <div class="bg-gradient-to-r from-purple-500/20 to-cyan-500/20 border border-purple-500/30 rounded-xl p-6 mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-black/40 p-4 rounded-lg">
                            <p class="text-sm text-green-400 font-bold">✓ Enfócate en PokerStars</p>
                            <p class="text-xs text-gray-400 mt-1">Tu mejor winrate (75%) está aquí</p>
                        </div>
                        <div class="bg-black/40 p-4 rounded-lg">
                            <p class="text-sm text-yellow-400 font-bold">→ Aumenta buy-ins</p>
                            <p class="text-xs text-gray-400 mt-1">Tus últimas 5 sesiones: +$350</p>
                        </div>
                        <div class="bg-black/40 p-4 rounded-lg">
                            <p class="text-sm text-cyan-400 font-bold">↑ 8% hasta el 1er lugar</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="bg-white/5 border border-white/10 rounded-xl p-6">
                        <h2 class="text-lg font-bold mb-4">Evolución de Profit (7 días)</h2>
            ...
            <div id="pagina-sesiones" class="pagina-contenido hidden">
                ...
                <div id="formularioSesion" class="hidden mb-8 bg-white/5 border border-white/10 rounded-xl p-8">
                    <h2 class="text-2xl font-bold mb-6">Nueva Sesión</h2>
                    ...
                    <form id="form-nueva-sesion" class="space-y-6">
                        ...
                        <!-- TIPO SESIÓN -->
                        <div>
                            <label class="block text-sm font-bold text-gray-300 mb-3">Tipo de Sesión</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-bold text-gray-300 mb-2">Hora de Finalización</label>
                        ...
                        <div>
                            ...
                            <textarea name="notas" placeholder="Cómo fue la sesión, qué manos jugaste, cómo te sentiste..." class="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-500 focus:border-cyan-500 focus:outline-none transition-all resize-none" rows="4"></textarea>
                        </div>
            ...
            <div id="pagina-perfil" class="pagina-contenido hidden">
                <div class="mb-8">
                    ...
                    <p class="text-gray-400">Información de tu cuenta</p>
                </div>
                <div class="bg-white/5 border border-white/10 rounded-xl p-12 text-center">
                    <p class="text-xl text-gray-400">Próximamente...</p>
                </div>
    ...
    <script>
        ...
        function actualizarTabla() {
            ...
            // Actualizar tabla en inicio también
